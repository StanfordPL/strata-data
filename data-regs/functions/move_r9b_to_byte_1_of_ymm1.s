  .text
  .globl move_r9b_to_byte_1_of_ymm1
  .type move_r9b_to_byte_1_of_ymm1, @function
#! maybe-read { %r9b %xmm1 }
#! maybe-write { %xmm1 }
#! must-undef { %r14 %r15 %ymm14 %ymm15 }
.move_r9b_to_byte_1_of_ymm1:
  # ----------------------------------------------------------------------------
  # move r9b to the byte 1 of ymm1
  # ----------------------------------------------------------------------------
  #
  # zero all-ones xmm15
  movq $-0x1, %r15
...
.size move_r9b_to_byte_1_of_ymm1, .-move_r9b_to_byte_1_of_ymm1
  retq
