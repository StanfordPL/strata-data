  .text
  .globl move_r9b_to_byte_18_of_ymm1
  .type move_r9b_to_byte_18_of_ymm1, @function
#! maybe-read { %r9b %ymm1 }
#! maybe-write { %ymm1 }
#! must-undef { %r14 %r15 %ymm14 %ymm15 }
.move_r9b_to_byte_18_of_ymm1:
  # ----------------------------------------------------------------------------
  # move r9b to the byte 18 of ymm1
  # ----------------------------------------------------------------------------
  #
  # zero all-ones xmm15
  movq $-0x1, %r15
...
.size move_r9b_to_byte_18_of_ymm1, .-move_r9b_to_byte_18_of_ymm1
  retq
